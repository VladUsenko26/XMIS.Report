...
// </summary>
// --------------------------------------------------------------------------------------------------------------------
namespace XMIS.Report.Client.Context
{
    using System;
    ...
    public class ControlManager
    {
        ...
        public UIElement GetControlPure(string key, params object[] parameter)
        {
            ...
            var controlType = this.controlTypeDictionary[key];
            object _userControl;
        ...
        {
            var containerControl = this.GetControl(containerName) as ContentControl;
            var elementControl = this.GetControl(elementName) as ContentControl;
        ...
        {
            var containerControl = this.GetControl(containerName) as ContentControl;
            var elementControl = this.GetControl(elementName, parameter) as ContentControl;
            var o = containerControl.FindName(regionName);
            ...
            {
                var regionControl = o as ContentControl;
                if (elementControl != null)
                {
