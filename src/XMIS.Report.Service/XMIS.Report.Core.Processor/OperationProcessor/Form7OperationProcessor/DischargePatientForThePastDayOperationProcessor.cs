// --------------------------------------------------------------------------------------------------------------------
// <copyright file="DischargePatientForThePastDayOperationProcessor.cs" company="">
//   
// </copyright>
// <summary>
//   The discharge patient for the past day operation processor.
// </summary>
// --------------------------------------------------------------------------------------------------------------------
...
namespace XMIS.Report.Core.Processor.OperationProcessor.Form7OperationProcessor
{
    ...
    /// The discharge patient for the past day operation processor.
    /// </summary>
    public class DischargePatientForThePastDayOperationProcessor : IOperationProcessor
    {
        /// <summary>
        /// The get count.
        /// </summary>
