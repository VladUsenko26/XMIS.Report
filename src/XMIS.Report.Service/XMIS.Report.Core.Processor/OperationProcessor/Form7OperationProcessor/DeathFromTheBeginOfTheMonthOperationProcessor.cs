// --------------------------------------------------------------------------------------------------------------------
// <copyright file="DeathFromTheBeginOfTheMonthOperationProcessor.cs" company="">
//   
// </copyright>
// <summary>
//   The death from the begin of the month operation processor.
// </summary>
// --------------------------------------------------------------------------------------------------------------------
namespace XMIS.Report.Core.Processor.OperationProcessor.Form7OperationProcessor
{
    ...
    ///     The death from the begin of the month operation processor.
    /// </summary>
    public class DeathFromTheBeginOfTheMonthOperationProcessor : IOperationProcessor
    {
        /// <summary>
        /// The get count.
        /// </summary>
