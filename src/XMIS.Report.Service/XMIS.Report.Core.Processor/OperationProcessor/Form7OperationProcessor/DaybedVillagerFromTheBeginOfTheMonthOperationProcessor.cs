// --------------------------------------------------------------------------------------------------------------------
// <copyright file="DaybedVillagerFromTheBeginOfTheMonthOperationProcessor.cs" company="">
//   
// </copyright>
// <summary>
//   The daybed villager from the begin of the month operation processor.
// </summary>
// --------------------------------------------------------------------------------------------------------------------
...
namespace XMIS.Report.Core.Processor.OperationProcessor.Form7OperationProcessor
{
    ...
    /// The daybed villager from the begin of the month operation processor.
    /// </summary>
    public class DaybedVillagerFromTheBeginOfTheMonthOperationProcessor : IOperationProcessor
    {
        /// <summary>
        /// The get count.
        /// </summary>
