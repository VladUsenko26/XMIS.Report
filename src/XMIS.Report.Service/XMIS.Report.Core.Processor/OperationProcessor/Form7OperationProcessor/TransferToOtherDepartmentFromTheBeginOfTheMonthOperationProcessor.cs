// --------------------------------------------------------------------------------------------------------------------
// <copyright file="TransferToOtherDepartmentFromTheBeginOfTheMonthOperationProcessor.cs" company="">
//   
// </copyright>
// <summary>
//   The transfer to other department from the begin of the month operation processor.
// </summary>
// --------------------------------------------------------------------------------------------------------------------
namespace XMIS.Report.Core.Processor.OperationProcessor.Form7OperationProcessor
{
    ...
    ///     The transfer to other department from the begin of the month operation processor.
    /// </summary>
    public class TransferToOtherDepartmentFromTheBeginOfTheMonthOperationProcessor : IOperationProcessor
    {
        /// <summary>
        /// The get count.
        /// </summary>
