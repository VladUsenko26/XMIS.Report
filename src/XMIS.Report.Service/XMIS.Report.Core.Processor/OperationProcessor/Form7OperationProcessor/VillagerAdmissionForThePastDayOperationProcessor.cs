// --------------------------------------------------------------------------------------------------------------------
// <copyright file="VillagerAdmissionForThePastDayOperationProcessor.cs" company="">
//   
// </copyright>
// <summary>
//   The villager admission for the past day operation processor.
// </summary>
// --------------------------------------------------------------------------------------------------------------------
namespace XMIS.Report.Core.Processor.OperationProcessor.Form7OperationProcessor
{
    ...
    ///     The villager admission for the past day operation processor.
    /// </summary>
    public class VillagerAdmissionForThePastDayOperationProcessor : IOperationProcessor
    {
        /// <summary>
        /// The get count.
        /// </summary>
