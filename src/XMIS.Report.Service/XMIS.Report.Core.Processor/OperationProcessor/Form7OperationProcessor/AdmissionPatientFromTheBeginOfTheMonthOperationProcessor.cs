// --------------------------------------------------------------------------------------------------------------------
// <copyright file="AdmissionPatientFromTheBeginOfTheMonthOperationProcessor.cs" company="">
//   
// </copyright>
// <summary>
//   The admission patient from the begin of the month operation processor.
// </summary>
// --------------------------------------------------------------------------------------------------------------------
namespace XMIS.Report.Core.Processor.OperationProcessor.Form7OperationProcessor
{
    ...
    ///     The admission patient from the begin of the month operation processor.
    /// </summary>
    public class AdmissionPatientFromTheBeginOfTheMonthOperationProcessor : IOperationProcessor
    {
        /// <summary>
        /// The get count.
        /// </summary>
            ...
            IList<HospitalizationBase> hospitalizationBaseCollection)
        {
            ...
            return AdmissionPatientCommonOperationProcessor.GetAdmissionCount(
                departmentId, 
                fromDateTime, 
                toDateTime, 
