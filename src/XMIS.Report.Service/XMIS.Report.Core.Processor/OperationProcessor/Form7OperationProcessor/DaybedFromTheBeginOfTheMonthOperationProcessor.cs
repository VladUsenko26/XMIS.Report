// --------------------------------------------------------------------------------------------------------------------
// <copyright file="DaybedFromTheBeginOfTheMonthOperationProcessor.cs" company="">
//   
// </copyright>
// <summary>
//   The daybed from the begin of the month operation processor.
// </summary>
// --------------------------------------------------------------------------------------------------------------------
...
namespace XMIS.Report.Core.Processor.OperationProcessor.Form7OperationProcessor
{
    ...
    /// The daybed from the begin of the month operation processor.
    /// </summary>
    public class DaybedFromTheBeginOfTheMonthOperationProcessor : IOperationProcessor
    {
        /// <summary>
        /// The get count.
        /// </summary>
            ...
            IList<HospitalizationBase> hospitalizationBaseCollection)
        {
            ...
            return DaybedCommonOperationProcessor.GetDaybedCount(
                departmentId, 
                fromDateTime, 
                toDateTime, 
