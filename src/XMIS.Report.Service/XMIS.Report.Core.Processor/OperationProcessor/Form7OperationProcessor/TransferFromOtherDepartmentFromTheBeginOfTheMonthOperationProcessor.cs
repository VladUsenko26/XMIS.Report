// --------------------------------------------------------------------------------------------------------------------
// <copyright file="TransferFromOtherDepartmentFromTheBeginOfTheMonthOperationProcessor.cs" company="">
//   
// </copyright>
// <summary>
//   The transfer from other department from the begin of the month operation processor.
// </summary>
// --------------------------------------------------------------------------------------------------------------------
namespace XMIS.Report.Core.Processor.OperationProcessor.Form7OperationProcessor
{
    ...
    ///     The transfer from other department from the begin of the month operation processor.
    /// </summary>
    public class TransferFromOtherDepartmentFromTheBeginOfTheMonthOperationProcessor : IOperationProcessor
    {
        /// <summary>
        /// The get count.
        /// </summary>
            ...
            IList<HospitalizationBase> hospitalizationBaseCollection)
        {
            ...
            return TransferFromOtherDepartmentCommonOperationProcessor.GetTransferCount(
                departmentId, 
                fromDateTime, 
                toDateTime, 
