// --------------------------------------------------------------------------------------------------------------------
// <copyright file="TransferPriorToDayForThePastDayOperationProcessor.cs" company="">
//   
// </copyright>
// <summary>
//   The transfer prior to day for the past day operation processor.
// </summary>
// --------------------------------------------------------------------------------------------------------------------
namespace XMIS.Report.Core.Processor.OperationProcessor.Form7OperationProcessor
{
    ...
    ///     The transfer prior to day for the past day operation processor.
    /// </summary>
    public class TransferPriorToDayForThePastDayOperationProcessor : IOperationProcessor
    {
        /// <summary>
        /// The get count.
        /// </summary>
