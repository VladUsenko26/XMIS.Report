// --------------------------------------------------------------------------------------------------------------------
// <copyright file="AdmissionPatientOperationProcessor.cs" company="">
//   
// </copyright>
// <summary>
//   The admission patient operation processor.
// </summary>
// --------------------------------------------------------------------------------------------------------------------
namespace XMIS.Report.Core.Processor.OperationProcessor.Form16OperationProcessor
{
    ...
    ///     The admission patient operation processor.
    /// </summary>
    public class AdmissionPatientOperationProcessor : IOperationProcessor
    {
        /// <summary>
        /// The get count.
        /// </summary>
