// --------------------------------------------------------------------------------------------------------------------
// <copyright file="SickPatientFromTheBeginOfPeriodOperationProcessor.cs" company="">
//   
// </copyright>
// <summary>
//   The sick patient from the begin of period operation processor.
// </summary>
// --------------------------------------------------------------------------------------------------------------------
...
namespace XMIS.Report.Core.Processor.OperationProcessor.Form16OperationProcessor
{
    ...
    /// The sick patient from the begin of period operation processor.
    /// </summary>
    public class SickPatientFromTheBeginOfPeriodOperationProcessor : IOperationProcessor
    {
        /// <summary>
        /// The get count.
        /// </summary>
