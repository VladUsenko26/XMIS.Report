// --------------------------------------------------------------------------------------------------------------------
// <copyright file="SickVillagerPatientOperationProcessor.cs" company="">
//   
// </copyright>
// <summary>
//   The sick villager patient operation processor.
// </summary>
// --------------------------------------------------------------------------------------------------------------------
...
namespace XMIS.Report.Core.Processor.OperationProcessor.Form16OperationProcessor
{
    ...
    /// The sick villager patient operation processor.
    /// </summary>
    public class SickVillagerPatientOperationProcessor : IOperationProcessor
    {
        /// <summary>
        /// The get count.
        /// </summary>
